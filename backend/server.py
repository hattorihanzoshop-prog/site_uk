...
# 1. Настройка безопасности (пароль берется из Vercel или ставится этот по умолчанию)
...
async def get_admin_stats():
    total_rev = sum(t.get("amount", 0) for t in db_data.get("payment_transactions", []))
    return {
